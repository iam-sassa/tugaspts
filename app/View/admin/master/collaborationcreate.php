    ...
    <main>
        <section class="glass">
            ...
            <div class="table" style="padding: 50px; align-items: center">
                ...
                <form action="<?= OOP\App\Core\Router::url('collaborationinsert') ?>" method="POST" style="text-align: center;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="textr" class="form-control" name="phone" placeholder="Enter phone">
                    </div>
                    <div class="form-group">
